...
class daftar ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Daftar - Burning Heroes", pos = wx.DefaultPosition, size = wx.Size( 629,440 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
...
class menu ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.img_sider = wx.StaticBitmap( self, wx.ID_ANY, wx.Bitmap( u"../Downloads/pexels-francesco-ungaro-1671325.jpg", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.Size( 200,530 ), 0 )
		bSizer1.Add( self.img_sider, 0, wx.ALL, 5 )
		...
		self.img_sider1 = wx.StaticBitmap( self, wx.ID_ANY, wx.Bitmap( u"../Downloads/pexels-francesco-ungaro-1671325.jpg", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.Size( 200,530 ), 0 )
...
class hero_menu ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Hero - Burning Heroes", pos = wx.DefaultPosition, size = wx.Size( 766,533 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
...
class fight ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		bSizer234.Add( self.m_textCtrl7, 0, wx.ALL, 5 )
